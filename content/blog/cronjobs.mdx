...
title: cron-jobs
date: '2021-03-06'
categories: ['heroku', 'cron-jobs']
draft: false
description: How to prevent the Heroku app from idling after 30 minutes?. And keep the app active.
banner: /images/cron-job-banner.jpeg
bannerCredit: Photo by Zukiman Mohamad from Pexels
---
...
<div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2">
  <img alt="cron-job dashboard" src="/images/api-route.png" width={1222} height={448} />
</div>
...
<div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2">
  <img alt="cron-job dashboard" src="/images/cron-job.png" width={1938} height={674} />
</div>
...
<div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2">
  <img alt="cron-job dashboard" src="/images/cron-title.png" width={1402} height={290} />
</div>
...
<div className="my-1 px-2 w-full overflow-hidden xl:my-1 xl:px-2">
  <img alt="cron-job dashboard" src="/images/cron-execution-time.gif" width={1222} height={448} />
</div>
